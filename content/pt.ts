  ...
  exp: {
    ...
    items: [
      ...
      },
      {
        ...
        period: "2021 — 2023",
        desc: "Projetos para Itaú Unibanco, Via Varejo e CPFL: protótipos web e mobile a partir de pesquisa e mapeamento de jornada, criação, alinhamento e validação de fluxos de apps e sites, layouts responsivos e design system. Entrevistas e dinâmicas com usuários, validação de hipóteses com pesquisas quali e quanti e contato constante com o time de desenvolvimento para garantir o entendimento das soluções, em metodologia ágil.",
      ...
      },
      {
        ...
        period: "2020",
        desc: "Alocada no UOL – Universo Online, projetando interfaces, produtos e serviços com foco nas necessidades de quem usa: mapas de navegação, protótipos, layouts e participação na definição dos textos. Pesquisa com clientes e análise de concorrentes em busca de melhorias; criação e implementação da linguagem visual do UOL nos produtos, com styleguides e bibliotecas alinhados ao guia geral. Acompanhei a montagem dos layouts e apresentei e defendi os conceitos para os clientes internos.",
